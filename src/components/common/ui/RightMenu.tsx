...
import GeometryExporter from "@/components/bento3d/ui/GeometryExporter"
import { useNavigationStore } from "@/stores/navigation"

interface RightMenuProps {
  geometryExporter?: ReactNode
  showGeometryExporterAtNav?: number
  showAdditionalLinks?: boolean
}

export const RightMenu: React.FC<RightMenuProps> = ({
  geometryExporter,
  showGeometryExporterAtNav = 2,
  ...
  const GeometryExporterComponent = geometryExporter || <GeometryExporter />
  ...
  return (
    <>
      <motion.div
        ...
        {currentNav === showGeometryExporterAtNav && (
          <motion.div
